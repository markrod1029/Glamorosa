                    ...
                    <div class="table-responsive bs-example widget-shadow">
                        ...
                        <table id="serviceTable" class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $serviceId = $user['sID'];
                                $ret = mysqli_query($con, "select tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tblbook.ID as bid,tblbook.AptNumber,tblbook.AptDate,tblbook.AptTimeStart,tblbook.AptTimeEnd,tblbook.Message,tblbook.BookingDate,tblbook.Status from tblbook join tbluser on tbluser.ID=tblbook.UserID where tblbook.Status='Rejected' AND tblbook.ServiceID='$serviceId'");
                                $cnt = 1;
